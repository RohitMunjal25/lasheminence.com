export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'le8q4x7m2v',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lash Eminence',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lasheminence.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lasheminence.com',
